...
test('both pages have unique IDs and every literal JS ID selector exists', () => {
    for (const [page, script] of [['dashboard.html', 'app.js'], ['dashboard.html', 'account.js'], ['dashboard.html', 'progress.js'], ['dashboard.html', 'workout-tools.js'], ['login.html', 'auth.js'], ['reset-password.html', 'reset-password.js']]) {
